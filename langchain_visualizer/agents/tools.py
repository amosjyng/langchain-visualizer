...
ice_hijack(ClickTool, "arun", is_async=True)
ice_hijack(CurrentWebPageTool, "arun", is_async=True)
ice_hijack(ExtractHyperlinksTool, "arun", is_async=True)
ice_hijack(ExtractTextTool, "arun", is_async=True)
ice_hijack(GetElementsTool, "arun", is_async=True)
ice_hijack(NavigateTool, "arun", is_async=True)
ice_hijack(NavigateBackTool, "arun", is_async=True)
